...
async function getFragmentsWithProgress() {
  const fragments = await sbFetch('/fragments?select=id,question,type,answer_main,answer_alternatives,reference_image_url,intro_text,intro_image_name,is_gift,is_active&order=id.asc', { service: true });
